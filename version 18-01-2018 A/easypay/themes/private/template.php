				...
				<div class="row">
					<div class="col-md-3 hidden-print">
						...
						<div class="list-group" >
							...
							<a href="<?php echo base_url('/account/bills'); ?>" class="list-group-item <?php echo (uri_string() == 'account/bills') ? 'active' : ''; ?>">
								<?php echo lang('users dashboard bill'); ?>
								<i class="icon-download icons pull-right"></i>
							</a>
							<a href="<?php echo base_url('/account/airtime_purchase'); ?>" class="list-group-item <?php echo (uri_string() == 'account/airtime_purchase') ? 'active' : ''; ?>">
								<?php echo lang('users dashboard airtime_purchase'); ?>
								<i class="icon-upload icons pull-right"></i>
							</a>
...
<!--							
							<a href="<?php echo base_url('/account/mobile_money_transfer'); ?>" class="list-group-item <?php echo (uri_string() == 'account/mobile_money_transfer') ? 'active' : ''; ?>">
								<?php echo lang('users menu mobiletransfer'); ?>
								<i class="icon-paper-plane icons pull-right"></i>
							</a>
-->							
