								...
								<form id="check" action="">
									<div class="plan-card-group">
										<div class="row">
											...
											<?php if($this->commission->display->mtn_sci_check) : ?>
											<?php // MTN ?>
											<div class="col-md-6 col-xs-6">
												<div class="radio-card">
													<input type="radio" class="planes-radio" name="method" value="mtn" id="10"/>
													<label for="7" id="7">
											...
											<?php if($this->commission->display->airtel_sci_check) : ?>
											<?php // AIRTEL ?>
											<div class="col-md-6 col-xs-6">
												<div class="radio-card">
													<input type="radio" class="planes-radio" name="method" value="airtel" id="11"/>
													<label for="7" id="7">
														<span class="card-title"><img class="img-responsive" src="<?php echo base_url();?>themes/private/img/pay/airtel.png" alt=""></span>
													</label>
												</div>
											</div>
											<?php endif; ?>
                ...
                <form id="paypal" name=paypal method="post" action="https://www.paypal.com/cgi-bin/webscr" accept-charset="UTF-8">
                  ...
                  <div class="row">
                        ...
                        <p><?php echo lang('core payment agreement'); ?></p>
									...
									<?php if($this->commission->display->check_mtn_sci) : ?>
									<?php echo form_open(site_url("SCI/form_mtncash/"), array("id" => "mtn")) ?>
									<input type="number" name="contact" value="<?php echo $order; ?>" />
									<input type="hidden" name="merchant" value="<?php echo $merchant; ?>" />
									<input type="hidden" name="amount" value="<?php echo $amount; ?>" />
									<input type="hidden" name="custom" value="<?php echo $custom; ?>" />
										<div class="row">
                        ...
                        <p><?php echo lang('core payment agreement'); ?></p>
									...
									<?php if($this->commission->display->check_airtel_sci) : ?>
									<?php echo form_open(site_url("SCI/form_airtelcash/"), array("id" => "airtel")) ?>
									<input type="number" name="contact" value="<?php echo $order; ?>" />
									<input type="hidden" name="merchant" value="<?php echo $merchant; ?>" />
									<input type="hidden" name="amount" value="<?php echo $amount; ?>" />
									<input type="hidden" name="custom" value="<?php echo $custom; ?>" />
