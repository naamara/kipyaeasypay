<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <?php echo form_open(site_url("account/start_mobile_deposit/"), array("" => "")) ?>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label><?php echo lang('users deposit contact'); ?></label>
              <input type="number" class="form-control" name="sender_contact" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')" placeholder="256788558138">
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              <label><?php echo lang('users deposit amount'); ?></label>
              <input type="text" class="form-control" name="amount" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')" placeholder="UGX">
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              <label><?php echo lang('users deposit message'); ?> </label>
