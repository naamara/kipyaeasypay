...
<div class="row">
  ...
  <div class="col-md-6 hidden-xs">
    <a href="<?php echo base_url('/account/history'); ?>" class="btn btn-primary pull-right">All transactions</a>
  </div>
</div>
