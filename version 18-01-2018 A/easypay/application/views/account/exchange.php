              ...
              <div class="form-group">
                <label><?php echo lang('users trans cyr'); ?></label>
                  <select class="form-control" name="currency">
                    <?php if($this->currencys->display->extra6_check) : ?>
                    <option value="debit_extra6">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <?php if($this->currencys->display->extra6_check) : ?>
          <div class="col-md-4">
            <p><strong>1 <?php echo $this->currencys->display->base_code ?></strong> = <?php echo $this->currencys->display->extra6_rate ?> <?php echo $this->currencys->display->extra6_code ?></p>
          </div>
          <?php endif; ?>
        </div>
        <hr>
              ...
              <div class="form-group">
                <label><?php echo lang('users trans cyr'); ?></label>
                  <select class="form-control" name="currency1" id="currency1">
                    ...
                    <?php endif; ?>
                    <?php if($this->currencys->display->extra6_check) : ?>
                    <option value="<?php echo $this->currencys->display->extra6_rate ?>">
                    <?php echo $this->currencys->display->extra6_code ?>
                    </option>
                    <?php endif; ?>
                  </select>
