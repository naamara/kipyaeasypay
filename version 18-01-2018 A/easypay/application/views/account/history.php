            ...
            <tr>
              ...
              <td>
                ...
                <img src="<?php  echo base_url();?>themes/default/img/icon/swift.png" class="img-circle" rel='tooltip' title="<?php  echo $view['sender']; ?>">
                 <?php }elseif($view['sender']=="MTN Mobile Money"){ ?>
                <img src="<?php  echo base_url();?>themes/default/img/icon/mtn1.png" class="img-circle" rel='tooltip' title="<?php  echo $view['sender']; ?>">
                 <?php }elseif($view['sender']=="Airtel Money"){ ?>
                <img src="<?php  echo base_url();?>themes/default/img/icon/airtel.png" class="img-circle" rel='tooltip' title="<?php  echo $view['sender']; ?>">
              ...
              <td>
                <?php if($view['type']==1){ ?>
                           ...
                           <?php if($view['type']==5){ ?>
                            ...
                            <?php }?>
                           <?php if($view['type']==6){ ?>
                              <?php  echo lang('users trans mobile'); ?>
                            <?php }else{ ?>
                            <?php }?>
                           <?php if($view['type']==7){ ?>
                              <?php  echo lang('users trans airtime'); ?>
                            <?php }else{ ?>
                            <?php }?>
              </td>
              <td>
              ...
              <td><a href="<?php echo base_url('/account/detail_transaction'); ?>/<?php  echo $view['id']; ?>" class="btn btn-default btn-block"><?php  echo lang('users trans detail'); ?></a></td>
            </tr>
