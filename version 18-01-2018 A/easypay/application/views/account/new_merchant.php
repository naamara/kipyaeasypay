<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div class="row">
      ...
      <div class="col-md-6 hidden-xs">
        <a href="<?php echo base_url('/account/merchants'); ?>" class="btn btn-primary margin-left-10 pull-right"><i class="icon-action-undo icons"></i> <?php echo lang('users disputes back'); ?></a>
      </div>
    </div>
