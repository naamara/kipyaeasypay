<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <a href="<?php echo base_url('/account/new_merchant'); ?>" class="btn btn-primary pull-right"><i class="icon-plus icons"></i> <?php echo lang('users merchants create'); ?></a>
      </div>
    </div>
          ...
          <?php if ($total) : ?>
            ...
            <tr>
              <td><?php echo $view['id']; ?></td>
               ...
               <td><a href="<?php echo base_url('/account/detail_merchant'); ?>/<?php echo $view['id']; ?>" class="btn btn-default btn-block"><?php echo lang('users trans detail'); ?></a></td>
            </tr>
