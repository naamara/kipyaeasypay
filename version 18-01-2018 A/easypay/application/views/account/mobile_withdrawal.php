<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div class="row">
      <div class="col-md-6">
         <h4 class="title"><?php echo lang('users title form_withdrawal'); //start_mobile_withdrawal ?></h4>
      </div>
    </div>

    <div class="panel panel-default">
      <div class="panel-body">
        <?php echo form_open(site_url("account/start_mobile_withdrawal/"), array("" => "")) ?>
        <div class="row">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label><?php echo lang('users withdrawal account'); ?> </label>
