        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <label><?php echo lang('users trans cyr'); ?></label>
                  <select class="form-control" name="currency">
                    ...
                    <option value="<?php echo $this->currencys->display->extra6_code ?>">
              ...
              <div class="col-md-12">
                <div class="form-group">
                    <label><?php echo lang('users reqest contact'); ?></label>
                    <input type="number" class="form-control" name="contact" placeholder="256788558138">
                  </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
