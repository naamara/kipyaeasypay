  ...
  <div class="panel-body">
    <div class="tab-content">
      ...
      <div class="tab-pane" id="profile">
		...
		<?php if($this->commission->display->mtn_dep_check) : ?>
				<form ation="https://perfectmoney.is/api/step1.asp" id="mtn" method="POST">
            <label><?php echo lang('account number'); ?></label>
					<input type="number" name="CONTACT" class="form-control" vlue="<?php echo $this->commission->display->mtn_dep_check ?>">
					<div class="form-group">
            <label><?php echo lang('users withdrawal amount'); ?>, <?php echo $this->currencys->display->base_code ?></label>
            <input type="text" class="form-control" name="PAYMENT_AMOUNT" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')" placeholder="0.00">
          </div>
          <div class="pull-right">
            ...
            <button type="submit" name="mtn_mobile_deposit" class="btn btn-primary"><?php echo lang('users deposit payment'); ?></button>
          </div>
				</form>
        <?php endif; ?>

		<?php if($this->commission->display->airtel_dep_check) : ?>
				<form ation="https://perfectmoney.is/api/step1.asp" id="airtel" method="POST">
            <label><?php echo lang('account number'); ?></label>
					<input type="number" name="CONTACT" class="form-control"  vlue="<?php echo $this->commission->display->account_airtel ?>">
					<div class="form-group">
            <label><?php echo lang('users withdrawal amount'); ?>, <?php echo $this->currencys->display->base_code ?></label>
            <input type="text" class="form-control" name="PAYMENT_AMOUNT" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')" placeholder="0.00">
          </div>
          <div class="pull-right">
            ...
            <button type="submit" name="airtel_money_deposit" class="btn btn-primary"><?php echo lang('users deposit payment'); ?></button>
          </div>
				</form>
        <?php endif; ?>
...
function setMTNFormVisible(id = "mtn") {
    var form = document.getElementById(id);         
    form.style.display = 'block';                              
}
