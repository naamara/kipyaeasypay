<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <div class="row">
      ...
      <div class="col-md-6 hidden-xs">
        ...
        <a href="<?php echo base_url('/account/btc_order'); ?>/<?php echo $transactions['user_comment']; ?>" class="btn btn-success margin-left-10 pull-right"><i class="fa fa-qrcode" aria-hidden="true"></i> <?php echo lang('users merchants pay'); ?></a> 
        <?}else{?>
        <?}?>
        ...
        <div class="row">
          <div class="col-md-4 col-xs-6">
            ...
            <div class="form-group">
              ...
              <p class="form-control-static"><?php echo ($transactions['currency']=='debit_extra6')? $this->currencys->display->extra6_code.' '.$transactions['amount']: $transactions['amount'] ?> <?if($transactions['currency']=='debit_base'){?>
                  ...
                  <?}else{?>
                  <?}?>
                  <?if($transactions['currency']=='debit_extra6'){?>
