                                              ...
                                              <div class="col-md-12">
                                               ...
                                               <?php // type ?>
                                                    ...
                                                    <div class="form-group col-sm-3<?php echo form_error('status') ? ' has-error' : ''; ?>">
                                                        ...
                                                        <div>
                                                            <label style="font-weight:500">
                                                                <?php echo form_radio(array('class'=>'radio', 'type'=>'radio', 'name'=>'status', 'id'=>'status-1', 'value'=>'1', 'checked'=>((isset($transactions['status']) && (int)$transactions['status'] == 1) ? 'checked' : FALSE))); ?>
                                                                <span><?php echo lang('admin trans pending'); ?></span>
                                                            </label>
                                                        </div>
                                                        <div>
                                                            <label style="font-weight:500">
                                                                <?php echo form_radio(array('class'=>'radio', 'type'=>'radio', 'name'=>'status', 'id'=>'status-2', 'value'=>'2', 'checked'=>((isset($transactions['status']) && (int)$transactions['status'] == 2) ? 'checked' : FALSE))); ?>
                                                                <span><?php echo lang('admin trans success'); ?></span>
                                                            </label>
                                                        </div>
                                                        <div>
                                                            <label style="font-weight:500">
                                                                <?php echo form_radio(array('class'=>'radio', 'type'=>'radio', 'name'=>'status', 'id'=>'status-3', 'value'=>'3', 'checked'=>((isset($transactions['status']) && (int)$transactions['status'] == 3) ? 'checked' : FALSE))); ?>
                                                                <span><?php echo lang('admin trans refund'); ?></span>
                                                            </label>
                                                        </div>
                                                        <div>
                                                            <label style="font-weight:500">
                                                                <?php echo form_radio(array('class'=>'radio', 'type'=>'radio', 'name'=>'status', 'id'=>'status-4', 'value'=>'4', 'checked'=>((isset($transactions['status']) && (int)$transactions['status'] == 4) ? 'checked' : FALSE))); ?>
                                                                <span><?php echo lang('admin trans dispute'); ?></span>
                                                            </label>
                                                        </div>
                                                        <div>
                                                            <label style="font-weight:500">
                                                                <?php echo form_radio(array('class'=>'radio', 'type'=>'radio', 'name'=>'status', 'id'=>'status-5', 'value'=>'5', 'checked'=>((isset($transactions['status']) && (int)$transactions['status'] == 5) ? 'checked' : FALSE))); ?>
                                                                <span><?php echo lang('admin trans blocked'); ?></span>
                                                            </label>
                                                        </div>
                                                      </div>

                                                      <?php // sender ?>
                                                      <div class="form-group col-sm-3<?php echo form_error('sender') ? ' has-error' : ''; ?>">
                                                      ...
                                                      <?php // sender ?>
                                                      <div class="form-group col-sm-3<?php echo form_error('receiver') ? ' has-error' : ''; ?>">
                                                      ...
                                                      <?php // time ?>
                                                      <div class="form-group col-sm-6<?php echo form_error('time') ? ' has-error' : ''; ?>">
