    ...
    <div class="card sameheight-item items" data-exclude="xs,sm,lg">
      <div class="card-header bordered">
        <div class="header-block">
          <h3 class="title"><?php echo lang('admin trans all'); ?></h3>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover">
          <thead>
            ...
            <tr>
                ...
                <th>
                    <a href="<?php echo current_url(); ?>?sort=id&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('admin trans status'); ?></a>
          ...
          <tbody>
            ...
            <tr <?if($transaction['status']==4){?> class="danger" <?}else{?><?}?> >
              ...
              <td class="center">
                  ...
                  <?}else{?>
                  <?}?>
                  <?if($transaction['currency']=='debit_extra6'){?>
                                                                ...
                                                                <div class="form-group" style="margin-bottom:1rem"> 
                                                                  <label class="control-label"><?php echo lang('admin trans status'); ?></label>
                                                                    <select name="status" id="status" class="form-control underlined">
                                                                           <option> </option>
                                                                           <option value="1"><?php echo lang('admin trans pending'); ?></option>
                                                                           <option value="2"><?php echo lang('admin trans success'); ?></option>
                                                                           <option value="3"><?php echo lang('admin trans refund'); ?></option>
                                                                           <option value="4"><?php echo lang('admin trans dispute'); ?></option>
                                                                           <option value="5"><?php echo lang('admin trans blocked'); ?></option>
                                                                        </select>
                                                                </div>
                                                                <div class="form-group" style="margin-bottom:1rem"> 
                                                                  <label class="control-label"><?php echo lang('admin trans receiver'); ?></label>
                                                                    <?php echo form_input(array('name'=>'receiver', 'id'=>'receiver', 'class'=>'form-control underlined', 'placeholder'=>lang('admin trans receiver'), 'value'=>set_value('receiver', ((isset($filters['receiver'])) ? $filters['receiver'] : '')))); ?>
                                                                </div>
                                                              </div>
                                                              <div class="col-md-12">
                                                                <div class="form-group" style="margin-bottom:1rem"> 
