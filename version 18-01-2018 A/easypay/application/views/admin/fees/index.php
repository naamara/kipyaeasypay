    ...
    <div class="row">
       ...
       <?php // PayPal?>
        ...
        <div class="form-group col-sm-2">
            ...
            <input type="checkbox" class="js-switch primary" name="mtn_check" value="1" <?php if($this->commission->display->mtn_check) echo "checked" ?>/>
        </div>

         <div class="form-group col-sm-10">
            <label><?php echo lang('admin fees fees'); ?> <?php echo lang('admin fees mtn'); ?>, %</label>
          <span class="required">*</span>
            <input type="text" class="form-control underlined" id="mtn_fee" name="mtn_fee" placeholder="50.00" value="<?php echo $this->commission->display->mtn_fee ?>"> 
        </div>
        ...
        <div class="form-group col-sm-2">
            ...
            <input type="checkbox" class="js-switch primary" name="airtel_check" value="1" <?php if($this->commission->display->airtel_check) echo "checked" ?>/>
        </div>

         <div class="form-group col-sm-10">
            <label><?php echo lang('admin fees fees'); ?> <?php echo lang('admin fees airtel'); ?>, %</label>
          <span class="required">*</span>
            <input type="text" class="form-control underlined" id="airtel_fee" name="airtel_fee" placeholder="50.00" value="<?php echo $this->commission->display->airtel_fee ?>"> 
        </div>
        ...
        <div class="form-group col-sm-2">
            ...
            <input type="checkbox" class="js-switch primary" name="africell_check" value="1" <?php if($this->commission->display->africell_check) echo "checked" ?>/>
        </div>

         <div class="form-group col-sm-10">
            <label><?php echo lang('admin fees fees'); ?> <?php echo lang('admin fees africell'); ?>, %</label>
          <span class="required">*</span>
            <input type="text" class="form-control underlined" id="africell_fee" name="africell_fee" placeholder="50.00" value="<?php echo $this->commission->display->africell_fee ?>"> 
        </div>
        ...
        <div class="form-group col-sm-2">
            ...
            <input type="checkbox" class="js-switch primary" name="smart_check" value="1" <?php if($this->commission->display->smart_check) echo "checked" ?>/>
        </div>

         <div class="form-group col-sm-10">
            <label><?php echo lang('admin fees fees'); ?> <?php echo lang('admin fees smart'); ?>, %</label>
          <span class="required">*</span>
            <input type="text" class="form-control underlined" id="smart_fee" name="smart_fee" placeholder="50.00" value="<?php echo $this->commission->display->smart_fee ?>"> 
        </div>
        ...
        <div class="form-group col-sm-2">
            ...
            <input type="checkbox" class="js-switch primary" name="vodafone_check" value="1" <?php if($this->commission->display->vodafone_check) echo "checked" ?>/>
        </div>

         <div class="form-group col-sm-10">
            <label><?php echo lang('admin fees fees'); ?> <?php echo lang('admin fees vodafone'); ?>, %</label>
          <span class="required">*</span>
            <input type="text" class="form-control underlined" id="vodafone_fee" name="vodafone_fee" placeholder="50.00" value="<?php echo $this->commission->display->vodafone_fee ?>"> 
        </div>
        ...
        <div class="form-group col-sm-2">
            ...
            <input type="checkbox" class="js-switch primary" name="smile_check" value="1" <?php if($this->commission->display->smile_check) echo "checked" ?>/>
        </div>

         <div class="form-group col-sm-10">
            <label><?php echo lang('admin fees fees'); ?> <?php echo lang('admin fees smile'); ?>, %</label>
          <span class="required">*</span>
            <input type="text" class="form-control underlined" id="smile_fee" name="smile_fee" placeholder="50.00" value="<?php echo $this->commission->display->smile_fee ?>"> 
        </div>
