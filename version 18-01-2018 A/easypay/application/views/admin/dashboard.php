  ...
  <div class="col-md-4">
    <div class="card card-widget-success">
      <div class="card-block">
        ...
        <div class="widget-link"><a href="<?php echo base_url('/admin/users'); ?>"><?php echo lang('admin dashboard link'); ?></a></div>
      </div>
   </div>
  </div>   
  ...
  <div class="col-md-4">
    <div class="card card-widget-warning">
      <div class="card-block">
        ...
        <div class="widget-link"><a href="<?php echo base_url('/admin/transactions'); ?>"><?php echo lang('admin dashboard link'); ?></a></div>
      </div>
   </div>
  </div>   
  ...
  <div class="col-md-4">
    <div class="card card-widget-info">
      <div class="card-block">
        ...
        <div class="widget-link"><a href="<?php echo base_url('/admin/disputes'); ?>"><?php echo lang('admin dashboard link'); ?></a></div>
      </div>
   </div>
  </div>  
     ...
     <div class="card sameheight-item items" data-exclude="xs,sm,lg">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover">
            <thead>
              ...
              <th><?php echo lang('admin trans actions'); ?></th>
            </thead>
            <tbody>
                      ...
                      <tr>
                         ...
                         <td class="center">
                            ...
                            <?php }else{?>
                            <?php } ?>
                            <?php if($view->currency=='debit_extra6'){ ?>
                                <?php echo $this->currencys->display->extra6_code; ?>
                            <?php }else{?>
                            <?php } ?>
                        </td>
                         ...
                         <td class="text-center">
                           <a href="<?php echo base_url('/admin/transactions/edit'); ?>/<?php echo $view->id ?>" class="btn btn-down btn-primary"><i class="icon-eye icons"></i></a> 
                        </td>
                      </tr>
                      <?php endforeach; ?>
                    </tbody>
      ...
      <div class="card-footer"> 
        <div class="text-center">
          <a href="<?php echo base_url('/admin/transactions'); ?>" class="btn btn-primary btn-sm"><i class="icon-eye icons"></i> <?php echo lang('admin dashboard link'); ?></a>
        </div>
      </div>
    </div>
  </div>  
...
<div class="col-md-12">
  <div class="card sameheight-item items" data-exclude="xs,sm,lg">
           ...
           <tbody>
             <?php foreach($log_ticket->result() as $view) : ?>
              <tr>
                ...
                <td>
                  <div class="text-center">
                    <a href="<?php echo base_url('/admin/tickets/edit'); ?>/<?php echo $view->id ?>" class="btn btn-down btn-primary"><i class="icon-eye icons"></i></a>
                  </div>
                </td>
              </tr>
             <?php endforeach; ?>
      ...
      <div class="card-footer"> 
        <div class="text-center">
          <a href="<?php echo base_url('/admin/tickets'); ?>" class="btn btn-primary btn-sm"><i class="icon-eye icons"></i> <?php echo lang('admin dashboard link'); ?></a>
        </div>
      </div>
    </div>
</div>
