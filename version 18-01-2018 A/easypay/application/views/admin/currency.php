...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="row">
        <?php //Extra currency 6?>
        <div class="form-group col-sm-1">
            <label>Activate</label>
            </br>
            <input type="checkbox" class="js-switch primary" name="extra6_check" value="1" <?php if($this->currencys->display->extra6_check) echo "checked" ?>/>
        </div>
        <div class="form-group col-sm-5">
            <label>Name Extra 6 currency</label>
            <span class="required">*</span>
            <input type="text" class="form-control underlined" id="extra6_name" name="extra6_name" placeholder="SHS Wallet" value="<?php echo $this->currencys->display->extra6_name ?>"> 
        </div>
        <div class="form-group col-sm-3">
            <label>Code Extra 6 currency</label>
          <span class="required">*</span>
            <input type="text" class="form-control underlined" id="extra6_code" name="extra6_code" placeholder="SHS" value="<?php echo $this->currencys->display->extra6_code ?>"> 
        </div>
         <div class="form-group col-sm-3">
