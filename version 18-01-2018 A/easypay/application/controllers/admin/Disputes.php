...
class Disputes extends Admin_Controller {
    ...
    */
    function index()
    {
        ...
        {
            $filters['transaction'] = $this->input->get('transaction', TRUE);
        }

        if ($this->input->get('time_transaction'))
        {
            $filters['time_transaction'] = $this->input->get('time_transaction', TRUE);
        }
			
		if ($this->input->get('time_dispute'))
        {
            $filters['time_dispute'] = $this->input->get('time_dispute', TRUE);
        }
			
		if ($this->input->get('claimant'))
        {
            $filters['claimant'] = $this->input->get('claimant', TRUE);
        }
			
		if ($this->input->get('defendant'))
        {
            $filters['defendant'] = $this->input->get('defendant', TRUE);
        }
