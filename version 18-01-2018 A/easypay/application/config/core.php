...
// Site Details
$config['site_version']          = "1.1.6";     // this is CI3 Fire Starter version - set it to 1.0.0 for your new project
...
$config['private_theme']         = "private";   // folder containing your private theme
